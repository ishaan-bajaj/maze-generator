...
import { idlFactory } from './maze_generator.did.js';
export { idlFactory } from './maze_generator.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MAZE_GENERATOR_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./maze_generator.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the maze_generator canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./maze_generator.did.js")._SERVICE>}
 */
export const maze_generator = createActor(canisterId);
