...
import { idlFactory } from './maze_generator_assets.did.js';
export { idlFactory } from './maze_generator_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MAZE_GENERATOR_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./maze_generator_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the maze_generator_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./maze_generator_assets.did.js")._SERVICE>}
 */
export const maze_generator_assets = createActor(canisterId);
